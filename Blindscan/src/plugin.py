	...
	def prepareScanData(self, orb, pol, band, is_scan):
		...
		if tunername in _blindscans2Nims:
			...
			if os.path.exists(exe_path):
				...
				if getBoxType() in ('9910lx','9911lx','9920lx','e4hd','e4hdcombo','e4hdhybrid','e4hdultra','odin2hybrid','odinplus','protek4k','sf208','sf228','sf238','singleboxlcd','twinboxlcd','twinboxlcdci5','mbmicro','mbmicrov2','cc1','ustym4kpro','anadol4k','anadol4kcombo','anadol4kv2','axashis4kcombo','axashis4kcomboplus','dinobot4k','dinobot4kl','dinobot4kmini','dinobot4kplus','dinobot4kpro','dinobot4kse','dinoboth265','axashistwin','dinobotu55','ferguson4k','mediabox4k','sf8008','gbtrio4k'):
					cmd += " %d" % self.is_c_band_scan
				if getBoxType() in ('cc1','ustym4kpro','anadol4k','anadol4kcombo','anadol4kv2','axashis4kcombo','axashis4kcomboplus','dinobot4k','dinobot4kl','dinobot4kmini','dinobot4kplus','dinobot4kpro','dinobot4kse','dinoboth265','axashistwin','dinobotu55','ferguson4k','mediabox4k','sf8008','gbtrio4k'):
					cmd += " %d" % orb[0]
